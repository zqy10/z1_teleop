  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::unitree_legged_msgs::HighState_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.head.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.head[i]);
    }
    if (v.head.empty() || true)
      s << "]";
    ...
    for (size_t i = 0; i < v.SN.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint32_t>::stream(s, true ? std::string() : indent + "    ", v.SN[i]);
    }
    if (v.SN.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.version.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint32_t>::stream(s, true ? std::string() : indent + "    ", v.version[i]);
    }
    if (v.version.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.motorState.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::unitree_legged_msgs::MotorState_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.motorState[i]);
    }
    if (v.motorState.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.footForce.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int16_t>::stream(s, true ? std::string() : indent + "    ", v.footForce[i]);
    }
    if (v.footForce.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "footForceEst: ";
    if (v.footForceEst.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.footForceEst.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int16_t>::stream(s, true ? std::string() : indent + "    ", v.footForceEst[i]);
    }
    if (v.footForceEst.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "rangeObstacle: ";
    if (v.rangeObstacle.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.rangeObstacle.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<float>::stream(s, true ? std::string() : indent + "    ", v.rangeObstacle[i]);
    }
    if (v.rangeObstacle.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "footPosition2Body: ";
    if (v.footPosition2Body.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.footPosition2Body.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::unitree_legged_msgs::Cartesian_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.footPosition2Body[i]);
    }
    if (v.footPosition2Body.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "footSpeed2Body: ";
    if (v.footSpeed2Body.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.footSpeed2Body.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::unitree_legged_msgs::Cartesian_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.footSpeed2Body[i]);
    }
    if (v.footSpeed2Body.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "wirelessRemote: ";
    if (v.wirelessRemote.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.wirelessRemote.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.wirelessRemote[i]);
    }
    if (v.wirelessRemote.empty() || true)
      s << "]";
    if (true || !indent.empty())
